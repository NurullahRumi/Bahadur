package  {
	...
	public class gamePlyingDal extends MovieClip {
		var parnt:gameFile;
		var char:character;
		var base:basement;
		...
		public function gamePlyingDal(par:gameFile) {
			// constructor code
			parnt = par;
			enableTouchEvent();
			swid = par.swid;
		...
		function addObject() {
			...
			if (rn == 0) { var nob0:prep_obj6 = new prep_obj6();  obj = new objects01(this, char, nob0); ynd = Math.random() * 0.2; obj.scor = -1000; }
			if (rn == 1) { var nob1:prep_obj7 = new prep_obj7();  obj = new objects01(this, char, nob1); ynd = Math.random() * 0.2; obj.scor = -2000; }
			if (rn == 2) { var nob2:prep_obj8 = new prep_obj8();  obj = new objects01(this, char, nob2); ynd = Math.random() * 0.2; obj.scor = -3000; }
			if (rn == 3) { var nob3:prep_obj9 = new prep_obj9();  obj = new objects01(this, char, nob3); ynd = Math.random() * 0.2; obj.scor = -4000; }
			if (rn == 4) { var nob4:prep_obj10 = new prep_obj10();  obj = new objects01(this, char, nob4); ynd = Math.random() * 0.2; obj.scor = -5000; }
			if (rn == 5) { var nob5:stone = new stone();  obj = new objects01(this, char, nob5); obj.scor = -1000; }
			if (rn == 6) { var nob6:stone = new stone();  obj = new objects01(this, char, nob6); obj.scor = -1000; }
			if (rn == 7) { var nob7:stone = new stone();  obj = new objects01(this, char, nob7); obj.scor = -1000; }
			...
			else obj.setPos(swid + rnd, shit * (0.6 + ynd));
			game.addChild(obj);
