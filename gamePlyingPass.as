package  {
	...
	public class gamePlyingPass extends MovieClip {
		var parnt:gameFile;
		var char:character;
		var base:basement;
		...
		public function gamePlyingPass(par:gameFile) {
			// constructor code
			parnt = par;
			enableTouchEvent();
			swid = par.swid;
		...
		function addObject() {
			...
			if (rn == 0) { var nob0:prep_obj16 = new prep_obj16();  obj = new objects01(this, char, nob0); ynd = Math.random() * 0.3; obj.scor = -5000; }
			if (rn == 1) { var nob1:prep_obj12 = new prep_obj12();  obj = new objects01(this, char, nob1); ynd = Math.random() * 0.1; obj.scor = -100; }
			if (rn == 2) { var nob2:prep_obj13 = new prep_obj13();  obj = new objects01(this, char, nob2); ynd = Math.random() * 0.1; obj.scor = -1000; }
			if (rn == 3) { var nob3:prep_obj14 = new prep_obj14();  obj = new objects01(this, char, nob3); ynd = Math.random() * 0.1; obj.scor = -500; }
			if (rn == 4) { var nob4:prep_obj15 = new prep_obj15();  obj = new objects02(this, char, nob4); ynd = Math.random() * 0.1; obj.scor = -3000; }
			if (rn == 5) { var nob5:stone = new stone();  obj = new objects01(this, char, nob5); ynd = Math.random() * 0.1; obj.scor = -500; }
			if (rn == 6) { var nob6:stone = new stone();  obj = new objects01(this, char, nob6); ynd = Math.random() * 0.1; obj.scor = -500; }
			if (rn == 7) { var nob7:stone = new stone();  obj = new objects01(this, char, nob7); ynd = Math.random() * 0.1; obj.scor = -500; }
